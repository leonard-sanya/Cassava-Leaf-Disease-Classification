...
We started with a simple CNN model, before moving to pretrained models including: ResNet34, ResNet50, ResNet101, MobileNet V2 to name a few.

We obtained an accuracy of 88.82% on the private leaderboard.

The project was done in collaboration with Millicent Omondi
